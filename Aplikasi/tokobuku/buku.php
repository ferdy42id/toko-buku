					...
					if(isset($_GET['action'])){
						if($_GET['action'] == 'input'){
							...
							if(!isset($_GET['id'])){
								...
								<div class=\"form-group\">
								<label>Judul Buku</label>
								<input type=\"text\" name=\"judulBuku\" value=\"".$Buku->getJudul()."\" required>
								</div>
								<div class=\"form-group\">
								<label>Nomor ISBN</label>
								<input type=\"text\" name=\"noISBN\" value=\"".$Buku->getNoISBN()."\" required>
								</div>
								<div class=\"form-group\">
								<label>penulis</label>
								<input type=\"text\" name=\"penulis\" value=\"".$Buku->getPenulis()."\"required>
								</div>
								<div class=\"form-group\">
								<label>penerbit</label>
								<input type=\"text\" name=\"penerbit\" value=\"".$Buku->getPenerbit()."\" required>
								</div>
								<div class=\"form-group\">
								<label>Tahun Terbit</label>
								<input type=\"text\" name=\"tahunTerbit\" value=\"".$Buku->getTahunTerbit()."\" onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 0' required>
								</div>
								<div class=\"form-group\">
								<label>Stok</label>
								<input type=\"text\" name=\"stok\" value=\"".$Buku->getStok()."\" onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 0' required>
								</div>
								<div class=\"form-group\">
								<label>Harga Pokok</label>
								<input type=\"text\" name=\"hargaPokok\" value=\"".$Buku->getHargaPokok()."\" onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 0' required>
								</div>
								<div class=\"form-group\">
								<label>Harga Jual</label>
								<input type=\"text\" name=\"hargaJual\" value=\"".$Buku->getHargaJual()."\" onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 0' required>
								</div>
								<div class=\"form-group\">
								<label>PPN</label>
								<input type=\"text\" name=\"PPN\" value=\"".$Buku->getPPN()."\" onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 0' required>
								</div>
								<div class=\"form-group\">
								<label>Diskon</label>
								<input type=\"text\" name=\"diskon\" value=\"".$Buku->getDiskon()."\" onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 0' required>
								</div>
								<div class=\"form-group\">
								<input type=\"submit\" name=\"submit\">
								<input type=\"hidden\" name=\"type\" value=\"3\">
